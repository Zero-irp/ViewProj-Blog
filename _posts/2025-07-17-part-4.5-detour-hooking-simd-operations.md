...
This construction of v17 is important as this is the one that adds translation to the ViewProjection matrix. This function is scattered 
...
- Build a custom hook: In a code cave, I’ll re-implement only the useful SIMD ops in the correct order. This way, 
...
I won’t be showing how to find code caves here, that is out of scope for this write-up. Just know that in this case, I’ll be using a code cave that’s 
...
bigger lesson: systems don’t always do things the cleanest way, and compilers sure as hell aren’t infallible. Do not blindly trust compilers!*
 ...
 <div class="post-nav">
  <a href="{{ site.baseurl }}/part-4.4-optimizing-redundant-simd-instructions/">&laquo; Previous: Part 4.4 </a>
  <a href="{{ site.baseurl }}/part-5-trampoline-hooking/">Next: Part 5 &raquo;</a>
</div>
