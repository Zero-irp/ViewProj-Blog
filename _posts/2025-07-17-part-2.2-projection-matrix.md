...
you can also find another explanation of the projection matrix by me here:  
[Math at Scale: Reversing the AAA Projection Matrix - Part 2: What is the Projection Matrix?](https://zero-irp.github.io/Proj-Blog/part-2-projection-matrix/) 

*We’ll later see how this matrix fits into the full pipeline and how the 3D position finally lands on your screen.*

<div class="post-nav">
  <a href="{{ site.baseurl }}/part-2.1-view-matrix/">&laquo; Part 2.1: View Matrix</a>
  <a href="{{ site.baseurl }}/part-2.3-View-Projection-matrix/">Part 2.3: View Projection Matrix &raquo;</a>
</div>
