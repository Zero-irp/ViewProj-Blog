...
You can skip ahead to SIMD Matrix multiplication if you're just here to learn theory)*
...
<div class="post-nav">
  <a href="{{ site.baseurl }}/part-4.1-tracing-matrix-construction/">&laquo; Previous: Part 4.1</a>
  <a href="{{ site.baseurl }}/part-4.3-completing-view-proj-matrix/">Next: Part 4.3 &raquo;</a>
</div>
