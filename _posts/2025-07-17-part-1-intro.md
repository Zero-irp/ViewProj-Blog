...
Projection Matrix. I figured I could reconstruct the View-Projection matrix myself by multiplying the projection matrix with the inverse of the camera world matrix as most graphics 
pipelines do. But the result didn’t match the actual View-Projection matrix.
...
- **[Part 4.2: Reversing SIMD Instructions for Matrix Math](../part-4.2-reversing-simd-instrustions/)**
  ...
  - [_mm_unpack (Theory)](../part-4.2-reversing-simd-instrustions/#mm_unpack-theory)
...
- **[Part 4.5: Detour Hooking to Optimize SIMD Operations](../part-4.5-detour-hooking-simd-operations/)**
  ...
  - [5 Byte jmp hook vs 13 Byte jmp hook](../part-4.5-detour-hooking-simd-operations/#5-byte-jmp-hook-vs-13-byte-jmp-hook)
