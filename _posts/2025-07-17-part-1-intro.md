...
Projection Matrix. I figured i could reconstruct the View-Projection matrix myself by multiplying the inverse of the camera world matrix with projection matrix as most Direct-X games 
...
<div class="post-nav">
  <a class="next-only" href="{{ site.baseurl }}/part-2.1-view-matrix/">Part 2.1: View Matrix &raquo;</a>
</div>
