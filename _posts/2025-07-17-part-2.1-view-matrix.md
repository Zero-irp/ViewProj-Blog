...
> The forward vector direction is typically (LookAtTarget - CameraPosition).normalized() for Left-Handed systems like Direct-X but for right-handed systems
the view matrix uses the negative Z-axis, which would be (CameraPosition - LookAtTarget).normalized(). 
...
<div class="post-nav">
  <a href="{{ site.baseurl }}/part-1-intro/">&laquo; Part 1: Introduction</a>
  <a href="{{ site.baseurl }}/part-2.2-projection-matrix/">Part 2.2: Projection Matrix &raquo;</a>
</div>
