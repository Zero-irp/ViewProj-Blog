...
Normalized Device Coordinates (NDC) and finally convert those to screen space. That’s essentially what World-to-Screen (W2S) does.**
 ...
 <div class="post-nav">
  <a href="{{ site.baseurl }}/part-5-trampoline-hooking/">&laquo; Part 5: Trampoline Hooking to Capture Entity Positions</a>
  <a href="{{ site.baseurl }}/part-7-final-esp/">Part 7: Final ESP with Imgui &raquo;</a>
</div>
